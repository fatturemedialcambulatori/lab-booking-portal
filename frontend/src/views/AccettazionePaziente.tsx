    ...
    <div className="space-y-6">
      ...
      {currentError ? (
        <div className="rounded-md bg-destructive/10 border border-destructive/30 px-4 py-3 text-sm text-destructive flex items-center gap-2">
          ...
          {isAmbulatorio
            ? "Impossibile caricare le accettazioni ambulatorio. Verifica che le API backend rispondano correttamente."
            : "Impossibile caricare le prenotazioni. Verifica che le API backend rispondano correttamente."}
        </div>
      ) : currentLoading ? (
