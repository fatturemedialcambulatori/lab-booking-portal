...
const ALIAS: Record<string, string> = {
  ...
  "convenzione attiva": "conventionActive", convenzioneattiva: "conventionActive", conventionactive: "conventionActive", "active convention": "conventionActive",
  "scadenza convenzione": "conventionExpiresAt", scadenzaconvenzione: "conventionExpiresAt", conventionexpiresat: "conventionExpiresAt", "convention expires at": "conventionExpiresAt",
  "testo convenzione": "conventionText", testoconvenzione: "conventionText", conventiontext: "conventionText", "convention text": "conventionText",
  "prestazioni convenzione": "conventionServices", prestazioniconvenzione: "conventionServices", "prestazioni in convenzione": "conventionServices", conventionservices: "conventionServices",
  "convenzioni associate": "linkedConventionIds", convenzioniassociate: "linkedConventionIds", linkedconventionids: "linkedConventionIds", "linked convention ids": "linkedConventionIds",
...
export function BulkImportDialog({ onClose, onImported }: Props) {
  ...
  const FIELDS = [
    ...
    { value: "conventionActive", label: "Convenzione attiva" },
    { value: "conventionExpiresAt", label: "Scadenza convenzione" },
    { value: "conventionText", label: "Testo convenzione" },
    { value: "conventionServices", label: "Prestazioni convenzione" },
    { value: "linkedConventionIds", label: "Convenzioni associate" },
